...
exports.addProduct = async (req, res) => {
    ...
    || typeof req.body.sizes === 'undefined' 
    ) {
        res.status(422).json({ msg: 'Invalid data' });
        return;
    }
    const {category,id_category,  name, price, release_date, describe, sizes } = req.body;
...
exports.updateProduct = async (req, res) => {
    ...
    let { name, id, category,id_category, price, release_date, describe, sizes} = req.body;
    let productFind;
    try {
...
exports.updateUser = async (req, res) => {
    ...
    let { email, firstName, lastName, address, phone_number, is_admin,is_manage } = req.body;
    let userFind;
    try {
...
exports.addUser = async (req, res) => {
    ...
    let { email, password, firstName, lastName, address, phone_number, is_admin, is_manage } = req.body;
    let userFind = null;
    try {
